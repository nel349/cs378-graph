...
TYPED_TEST(TestGraph, edge_iterator_constructor_2) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
	...
	edge_descriptor e0 = add_edge(vdA0, vdA1, g).first;  // 0 edges
	edge_descriptor e1 = add_edge(vdA1, vdA4, g).first; //1 edge
...
TYPED_TEST(TestGraph, edge_iterator_constructor_3) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
...
TYPED_TEST(TestGraph, edge_iterator_plusplus_2) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
...
TYPED_TEST(TestGraph, edge_iterator_plusplus_3) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
	...
	add_edge(vdA0, vdA1, g).first; //0 edge Again
	ASSERT_EQ(6, num_edges(g) ) ;
...
TYPED_TEST(TestGraph, edges_3) {
	...
	edge_descriptor e00 = add_edge(vdA0, vdA0, g).first;//4 edge
...
TYPED_TEST(TestGraph, Adjacent_Vertices_3){
	...
	std::pair<adjacency_iterator, adjacency_iterator> p = adjacent_vertices(vdA0, g);
	adjacency_iterator b = p.first;
	adjacency_iterator e = p.second;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_constructor_2) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
	...
	std::pair<adjacency_iterator, adjacency_iterator> p = adjacent_vertices(vdA2, g);
	adjacency_iterator b = p.first;
	adjacency_iterator e = p.second;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_constructor_3) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
	...
	std::pair<adjacency_iterator, adjacency_iterator> p = adjacent_vertices(vdA5, g);
	adjacency_iterator b = p.first;
	adjacency_iterator e = p.second;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_plusplus_2) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_plusplus_3) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
	...
	add_edge(vdA0, vdA0, g); //0 edge
	add_edge(vdA0, vdA1, g);//1 edge
	add_edge(vdA0, vdA2, g);//2 edge
	add_edge(vdA0, vdA3, g);//3 edge
	add_edge(vdA0, vdA4, g);//4 


	add_edge(vdA0, vdA6, g).first;
	add_edge(vdA0, vdA5, g).first;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_minusminus_1) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_minusminus_2) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
...
TYPED_TEST(TestGraph, iterator_adjacent_vertices_minusminus_3) {
	typedef typename TestFixture::graph_type         graph_type;
	typedef typename TestFixture::vertex_descriptor  vertex_descriptor;
	typedef typename TestFixture::edge_descriptor    edge_descriptor;
	typedef typename TestFixture::vertex_iterator    vertex_iterator;
